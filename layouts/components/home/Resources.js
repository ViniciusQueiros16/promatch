...
function Resources() {
  ...
  return (
    <ScrollAnimationWrapper>
      <motion.div
        className="mx-auto max-w-7xl px-6 py-6 md:px-12 xl:px-6"
      ...
      >
        <div className="md:w-2/3 lg:w-1/2">
          ...
          <h2 className="my-6 text-2xl font-bold text-gray-700 dark:text-white md:text-4xl">
            Explore ProMatch Resources
          </h2>
          <p className="text-gray-600 dark:text-gray-300">
            ProMatch offers more than just job connections. Check out the
            features that make us unique.
          </p>
        </div>
        <div className="mt-8 grid divide-x divide-y divide-gray-100 overflow-hidden rounded-3xl border border-gray-100 text-gray-600 dark:divide-gray-700 dark:border-gray-700 sm:grid-cols-2 lg:grid-cols-4 lg:divide-y-0 xl:grid-cols-4">
          {/* Feature 1 */}
          <div className="group relative bg-white transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10 dark:bg-gray-800">
            ...
            <div className="relative space-y-8 p-8 py-12">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Easily find the right professional or job opportunity.
                </p>
              </div>
              <a
                href="#"
          ...
          <div className="group relative bg-white transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10 dark:bg-gray-800">
            ...
            <div className="relative space-y-8 p-8 py-12">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Seamless chat and negotiation with matched professionals.
                </p>
              </div>
              <a
                href="#"
          ...
          <div className="group relative bg-white transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10 dark:bg-gray-800">
            ...
            <div className="relative space-y-8 p-8 py-12">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-600 dark:text-gray-300">
                  Explore additional features for an enhanced experience.
                </p>
              </div>
              <a
                href="#"
          ...
          {/* Feature 4 - Jobs and Services Feed */}
          <div className="group relative bg-gray-50 transition hover:z-[1] hover:shadow-2xl hover:shadow-gray-600/10 dark:bg-gray-900">
            ...
            <div className="relative space-y-8 p-8 py-12 transition duration-300 group-hover:bg-white dark:group-hover:bg-gray-800">
              <img
                ...
                width="512"
                height="512"
                alt="Jobs and Services Feed Icon"
              />
              <div className="space-y-2">
                <h5 className="group-hover:text-secondary text-xl font-semibold text-gray-700 transition dark:text-white">
                  Jobs and Services Feed
                </h5>
                <p className="text-gray-600 dark:text-gray-300">
                  Discover job opportunities and services in your feed.
                </p>
              </div>
              <a
                href="#"
