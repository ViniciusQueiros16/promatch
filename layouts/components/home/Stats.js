        ...
        <div className="flex-row-reverse justify-between space-y-6 text-gray-600 md:flex md:gap-6 md:space-y-0 lg:items-center lg:gap-12">
          ...
          <div className="md:7/12 lg:w-1/2">
            ...
            <p className="my-8 text-gray-600 dark:text-gray-300">
              Explore the impact of ProMatch on professionals and businesses.
            </p>
            <div className="space-y-4 divide-y divide-gray-100 dark:divide-gray-800">
              <div className="mt-8 flex gap-4 md:items-center">
                ...
                <div className="w-5/6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Stay connected and chat with professionals anytime.
                  </p>
                </div>
              </div>
              <div className="flex gap-4 pt-4 md:items-center">
                ...
                <div className="w-5/6">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    Track real-time locations for efficient service delivery.
                  </p>
                </div>
              </div>
            </div>
