...
const HomePost = ({
  ...
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      className="my-7 rounded-sm border bg-white"
        ...
        <div className="m-auto flex space-x-10">
          {hasLikes ? (
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className="btn h-6 w-6 text-blue-500"
              >
            ...
            >
              <svg
                ...
                strokeWidth={1.5}
                stroke="currentColor"
                className="btn h-6 w-6 text-gray-500"
              >
                <path
                  strokeLinecap="round"
          ...
          >
            <svg
              ...
              viewBox="0 0 24 24"
              fill="currentColor"
              className="btn h-6 w-6 -rotate-45 text-gray-500"
            >
